...
public class Get_dieselrate extends AsyncTask<String, String, String> {
    ...
    public Get_dieselrate(Context context, Fuels_details_activity fuelsdetailsactivity) {
    ...
    protected void onPreExecute() {
        ...
        pd.setMessage("fetching diesel rate...");
    ...
    protected String doInBackground(String... params) {
        ...
        Request request = new Request.Builder()
                .url("http://52.36.211.72:5555/gateway/FuelPriceIndia/1.0/main/"+ fuelsdetailsactivity.selected_city+"/diesel/price")
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if (jsonData != null) {
            ...
            try {
                ...
                fuelsdetailsactivity.setrate1(status);
